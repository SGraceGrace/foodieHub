...
public class SecurityConfig {
  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
    return httpSecurity.csrf(AbstractHttpConfigurer::disable)
        ...
        .authorizeHttpRequests(request -> request.requestMatchers("/api/v1/auth/login", "/api/v1/auth/signup", "/api/v1/refresh-token", "/api/v1/contact", "/api/v1/slides", "/api/v1/partner/register", "/api/v1/driver/register", "/oauth2/**", "/login/oauth2/**").permitAll())
